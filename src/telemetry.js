 ...
 *
 * Sendet NUR: zufällige Install-ID, Version, Browser-Typ, Gesamt-Block-Zähler.
 * KEINE URLs, keine besuchten Seiten, keine personenbezogenen Daten.
 *
 * Heartbeat / "online" im Admin: nur wenn ein Twitch- oder YouTube-Tab offen ist.
 * Browser im Hintergrund ohne Stream-Tab = nicht online.
 *
...
/** True wenn mindestens ein Twitch-/YouTube-Tab geoeffnet ist (nicht discarded). */
...
export function initTelemetry() {
  try {
    ...
    /* alarms/permissions evtl. nicht verfuegbar */
  }
}

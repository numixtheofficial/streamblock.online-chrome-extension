/**
 * i18n.js — Language for popup & detail (DE / EN)
 */
(function () {
  'use strict';
  ...
  var STRINGS = {
    de: {
      ...
      'header.tagline': 'Werbe- & Tracker-Blocker',
      ...
      'method.youtubeNet.name': 'Netzwerk-Blockade',
      'method.youtubeNet.desc': 'Blockiert YouTubes Werbe- & Tracking-Anfragen direkt. Bei Problemen ausschalten.',
    ...
    en: {
      ...
      'header.tagline': 'Ad & tracker blocker',
      'header.details': 'Details',
      ...
      'method.youtubeNet.name': 'Network block',
      'method.youtubeNet.desc': 'Blocks YouTube\'s ad & tracking requests directly. Turn off if issues occur.',
      'method.network.name': 'Network blocking',
